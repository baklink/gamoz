...
if (isset($_GET['deleteid'])) {
	echo 'Do you really want to delete Project ? <a href="project_list.php?yesdelete=' . $_GET['deleteid'] . '">Yes</a> | <a href="project_list.php">No</a>';
	exit();
}
                                      ...
                                      echo " <tr>";
                                        	...
                                        	echo"<td>". $row['file'] ."</td>";
                                                echo"<td>". $row['branch'] ."</td>";
                                                                                        ...
                                                                                        $id= $row["id"];
                                                                                      echo  "<td><a href='project_list.php?deleteid=$id'>delete</a></td>";
                                            echo " </tr>";
